package com.xxl.job.saas.core.trigger;
...
import com.xxl.job.saas.core.schedule.XxlJobDynamicScheduler;
import com.xxl.job.saas.core.thread.JobFailMonitorHelper;
...
public class XxlJobTrigger {
    ...
    private static void processTrigger(XxlJobGroup group, XxlJobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total) {
        ...
        triggerMsgSb.append("<br>").append(I18nUtil.getString("jobconf_trigger_admin_adress")).append("：").append(LOCALADDRESS);/*IpUtil.getIp()*/
