        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "jobinfo">active</#if>"><a
                            href="${request.contextPath}/jobinfo/index1"><i
                                class="fa fa-circle-o text-yellow"></i><span>${I18n.jobinfo_name1}</span></a></li>
                <li class="nav-click <#if pageName == "jobinfo2">active</#if>"><a
                            href="${request.contextPath}/jobinfo/index2"><i
                                class="fa fa-circle-o text-gray"></i><span>${I18n.jobinfo_name2}</span></a></li>
