...
<script>
    ...
    export default {
        ...
        created() {
            this.$http.post(this.baseUrl + '/log/listAppName', {}).then(
                response => {
        ...
        methods: {
            ...
            updateRetryCount: function () {
                ...
                this.$http.post(this.baseUrl + '/log/update', {
            ...
            query: function () {
                this.$http.post(this.baseUrl + '/log/listPage', {
                    "pageParameter": {
            ...
            deleteAll: function () {
                ...
                this.$http.post(this.baseUrl + '/log/batchRemove', {
                    "applicationName": this.selected,
                    "ids": groupIds
                }).then(
                    response => {
