...
public class MythTransactionAspectServiceImpl implements MythTransactionAspectService {
    ...
    /**
     * Instantiates a new Myth transaction aspect service.
     *
     * @param mythTransactionFactoryService the myth transaction factory service
     */
    @Autowired
    ...
    public Object invoke(final MythTransactionContext mythTransactionContext, final ProceedingJoinPoint point) throws Throwable {
        final Class clazz = mythTransactionFactoryService.factoryOf(mythTransactionContext);//工厂获取事务上下文
