...
import static com.maibaduoduo.jwt.common.BaseContextConstants.BASIC_HEADER_PREFIX;
import static com.maibaduoduo.jwt.common.code.ExceptionCode.JWT_BASIC_INVALID;
...
public class JwtUtil {
    ...
    public static Token createJWT(Map<String, String> user, long expire) {
        ...
        tokenInfo.setToken(builder.compact());//.compact();//压缩
