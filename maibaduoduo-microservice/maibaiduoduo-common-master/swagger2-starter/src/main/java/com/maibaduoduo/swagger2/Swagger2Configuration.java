...
public class Swagger2Configuration implements WebMvcConfigurer {
    ...
    public static class ZhSecurityConfiguration {
        ...
        @ConditionalOnProperty(name = "maibaiduoduo.swagger.production", havingValue = "true")
        ...
        @Bean
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "maibaduoduo.swagger.basic.enable", havingValue = "true")
        ...
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "maibaduodduo.swagger.markdown.enable", havingValue = "true")
