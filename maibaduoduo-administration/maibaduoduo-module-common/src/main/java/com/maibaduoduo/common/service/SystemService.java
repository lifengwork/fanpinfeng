package com.maibaduoduo.common.service;

import com.maibaduoduo.common.annotation.SessionDAO;
import com.maibaduoduo.common.entity.Page;
import com.maibaduoduo.common.shiro.SystemAuthorizingRealm;
import com.maibaduoduo.common.sys.dao.MenuDao;
import com.maibaduoduo.common.sys.dao.RoleDao;
import com.maibaduoduo.common.sys.dao.UserDao;
import com.maibaduoduo.common.sys.entity.Menu;
import com.maibaduoduo.common.sys.entity.Office;
import com.maibaduoduo.common.sys.entity.Role;
...
public class SystemService extends BaseService implements InitializingBean {
	private static  Logger logger = LoggerFactory.getLogger("SystemService");
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	 ...
	 */
	public static String entryptPasswordBack(String plainPassword) {
	 ...
	 * @return 验证成功返回true
	 */
	public static boolean validatePasswordBack(String plainPassword, String password) {
		String plain = Encodes.unescapeHtml(plainPassword);
	...
	public  boolean validatePassword(String plainPassword, String cryptPassword) {
		return bCryptPasswordEncoder.matches(plainPassword,cryptPassword);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
	public Boolean outUserInRole(Role role, User user) throws ServiceException {
	...
	@Transactional(readOnly = false)
	public User assignUserToRole(Role role, User user) throws ServiceException {
		if (user == null){
			return null;
		}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+ Global.getConfig("productName")+"  - Powered By http://maibaduoduo.com\r\n");
		sb.append("\r\n======================================================================\r\n");
