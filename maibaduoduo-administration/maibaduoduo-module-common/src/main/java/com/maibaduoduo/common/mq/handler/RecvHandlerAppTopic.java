 ...
 */
public class RecvHandlerAppTopic implements ChannelAwareMessageListener {
    private static Logger log = LoggerFactory.getLogger(RecvHandlerAppTopic.class);
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        try {
            ...
            System.out.println("App==测试RabbitMq：" + jsonData.get("id_topic").asText() + ",Topic发布模式：" + jsonData.get("name_topic").asText());
            /**
             * to do 消息处理 成功或者失败
             */
           if(true)
