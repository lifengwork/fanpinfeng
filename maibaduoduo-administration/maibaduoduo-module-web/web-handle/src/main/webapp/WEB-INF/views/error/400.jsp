...
if (ex != null) {
	if (ex instanceof BindException) {
		...
		LogManager.getLogger("400.jsp").warn(ex.getMessage(), ex);
...
<%@page import="com.maibaduoduo.common.utils.Servlets"%>
<%@page import="com.maibaduoduo.common.utils.Exceptions"%>
<%@page import="com.maibaduoduo.common.utils.StringUtils"%>
