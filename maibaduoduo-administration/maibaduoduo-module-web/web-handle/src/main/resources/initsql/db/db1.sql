/*
 ...
 Source Schema         : maibaduoduo_base_000000

 Target Server Type    : MySQL
 Target Server Version : 80022
 File Encoding         : 65001

 Date: 01/09/2021 23:24:59
*/
...
CREATE TABLE `c_common_opt_log`  (
  ...
  `type` varchar(5)  NULL DEFAULT 'OPT' COMMENT '日志类型LogTypeOPT操作类型;EX异常类型',
...
CREATE TABLE `d_tenant`  (
  ...
  `type` varchar(10)  NULL DEFAULT 'CREATE' COMMENT '类型CREATE创建;REGISTER注册',
  `status` varchar(10)  NULL DEFAULT 'NORMAL' COMMENT '状态NORMAL正常;FORBIDDEN禁用;WAITING待审核;REFUSE拒绝',
...
CREATE TABLE `oauth_resource`  (
  ...
  `tenant_code` varchar(6)  NULL DEFAULT NULL COMMENT '租户代码',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `xxl_job_qrtz_trigger_registry`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23  ROW_FORMAT = Dynamic;
