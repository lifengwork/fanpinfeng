 ...
 */
package com.maibaduoduo.activiti.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.maibaduoduo.common.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.maibaduoduo.common.sys.entity.User(null, userId)))){
