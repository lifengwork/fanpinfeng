package com.maibaduoduo.activiti.act.service;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.maibaduoduo.activiti.act.dao.ActDao;
import com.maibaduoduo.activiti.act.entity.Act;
import com.maibaduoduo.activiti.act.service.cmd.CreateAndTakeTransitionCmd;
import com.maibaduoduo.activiti.act.service.cmd.JumpTaskCmd;
import com.maibaduoduo.activiti.act.service.creator.ChainedActivitiesCreator;
import com.maibaduoduo.activiti.act.service.creator.MultiInstanceActivityCreator;
import com.maibaduoduo.activiti.act.service.creator.RuntimeActivityDefinitionEntityIntepreter;
import com.maibaduoduo.activiti.act.service.creator.SimpleRuntimeActivityDefinitionEntity;
import com.maibaduoduo.activiti.act.utils.ActUtils;
import com.maibaduoduo.activiti.act.utils.ProcessDefCache;
import com.maibaduoduo.activiti.act.utils.ProcessDefUtils;
...
//		ProcessInstance processInstance = runtimeService.createProcessInstanceQuery().processInstanceId(executionId).singleResult();
		...
		return processEngine.getProcessEngineConfiguration().getProcessDiagramGenerator()
				.generateDiagram(bpmnModel, "png", activeActivityIds,Lists.newArrayList(),
						this.processEngine.getProcessEngineConfiguration().getActivityFontName(),
						this.getProcessEngine().getProcessEngineConfiguration().getLabelFontName(),
						this.getProcessEngine().getProcessEngineConfiguration().getAnnotationFontName(),
						null,1.0);
	}
