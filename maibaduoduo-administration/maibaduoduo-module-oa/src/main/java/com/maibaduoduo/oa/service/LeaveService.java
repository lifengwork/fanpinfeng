package com.maibaduoduo.oa.service;
...
import com.maibaduoduo.common.utils.Collections3;
import com.maibaduoduo.common.utils.StringUtils;
import com.maibaduoduo.oa.dao.LeaveDao;
...
public class LeaveService extends BaseService {
    ...
    public void save(Leave leave, Map<String, Object> variables) {
        ...
        variables.put("username", leave.getCurrentUser().getLoginName());
        ...
        logger.debug("start process of {key={}, bkey={}, pid={}, variables={}}", new Object[]{ActUtils.PD_LEAVE[0], businessKey, processInstance.getId(), variables});
    ...
    public List<Leave> findTodoTasks(String userId) {
        ...
        for (Task task : tasks) {
            ...
            Leave leave = leaveDao.get(businessKey.split(":")[1]);
            leave.setTask(task);
            leave.setProcessInstance(processInstance);
